window.onload = function() {
  ...
  var camera = new THREE.PerspectiveCamera(45,1,1,400);
  camera.setLens(35);
  ...
  books[0].position.x = 10;
  books[0].position.y = 15;
  ...
  var animate = function(t) {
    ...
    var hvyAnimation = control.Animation*(hvyFreq/100); 
    uniforms.effectAmount.value = hvyAnimation/100;
    var i;
